...
function handleUImessage_impl(ui, message) {
    ...
    switch (prefix) {
        ...
        case PREFIX_TYPE.CHARACTER:
            {
                ...
                let match = (0, Helper_1.isOfClassDeep)(json_object, new CharWrapper(), { print: true, obj_name: "char_wrapper", add_missing_fields: true });
                if (match === false) {
        ...
        case PREFIX_TYPE.CONFIG:
            {
                let match = (0, Helper_1.isOfClassDeep)(json_object, new config_1.Config(), { print: true, obj_name: "config", add_missing_fields: true });
                if (match === false) {
        ...
        case PREFIX_TYPE.AUTH:
            {
                let match = (0, Helper_1.isOfClassDeep)(json_object, new auth_1.Auth(), { print: true, obj_name: "auth", add_missing_fields: true });
                if (match === false) {
        ...
        case PREFIX_TYPE.NEW_PRESET:
            {
                ...
                ui.send("PRESETS", { presets: Waifu_1.wAIfu.state.presets, current: Waifu_1.wAIfu.state.current_preset });
            }
            break;
        default:
